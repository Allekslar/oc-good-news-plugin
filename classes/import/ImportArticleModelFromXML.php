...
use Lovata\GoodNews\Models\XmlImportSettings;

/**
 * Class ImportArticleModelFromXML
 * @package Lovata\GoodNews\Classes\Import
 * @author  Andrey Kharanenka, a.khoronenko@lovata.com, LOVATA Group
 */
class ImportArticleModelFromXML extends AbstractImportModelFromXML
{
    const EXTEND_FIELD_LIST = 'goodnews.article.extend_xml_import_fields';
    const EXTEND_IMPORT_DATA = 'goodnews.article.extend_xml_import_data';
    ...
    /**
     * ImportArticleModelFromXML constructor.
     */
    ...
    public function getFields() : array
    {
        $this->arFieldList = [
            ...
            'additional_category' => Lang::get('lovata.goodnews::lang.field.additional_category'),
        ];
    ...
    protected function prepareImportSettings()
    {
        ...
        $this->bDeactivate = (bool) XmlImportSettings::getValue('article_deactivate');
        $this->arImportSettings = XmlImportSettings::getValue('article');
        $this->sElementListPath = XmlImportSettings::getValue('article_path_to_list');

        $iFileNumber = XmlImportSettings::getValue('article_file_path');
        if ($iFileNumber !== null) {
