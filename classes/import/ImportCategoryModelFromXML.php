...
{
    const EXTEND_FIELD_LIST = 'GoodNews.category.extend_xml_import_fields';
    const EXTEND_IMPORT_DATA = 'GoodNews.category.extend_xml_import_data';
    ...
    public function getFields() : array
    {
        $this->arFieldList = [
            ...
            'parent_id'     => Lang::get('lovata.GoodNews::lang.field.category_parent_id'),
            'children'      => Lang::get('lovata.GoodNews::lang.field.children_category'),
        ];
